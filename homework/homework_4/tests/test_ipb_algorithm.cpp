...
using named_vector = ipb::named_vector<int>;

TEST_CASE("ipb::accumulate", "[ipb_algorithm]") {
  named_vector v{"name", {1, 2, 3, 4}};
...
TEST_CASE("ipb::all_even", "[ipb_algorithm]") {
  named_vector even_v{"even_vector", {2, 4, 8, 14}};
...
TEST_CASE("ipb::sort", "[ipb_algorithm]") {
  named_vector v_unsorted{"unsorted_vector", {12, 4, 0, 1}};
  ipb::sort(v_unsorted);
